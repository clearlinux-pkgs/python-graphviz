...
%prep
%setup -q -n graphviz-0.13.2
cd %{_builddir}/graphviz-0.13.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583704226
...
cp %{_builddir}/graphviz-0.13.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/python-graphviz/7d90580e9d3b0bd1aefed59d0783267e06786398
