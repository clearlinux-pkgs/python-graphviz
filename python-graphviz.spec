...
%prep
%setup -q -n graphviz-0.14
cd %{_builddir}/graphviz-0.14
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587759355
...
cp %{_builddir}/graphviz-0.14/LICENSE.txt %{buildroot}/usr/share/package-licenses/python-graphviz/1f08db7230df3793d0b60d818464578883a16227
